from brackjack_art import logo
import random
import os
...
def play():
    ...
    while 0 < computer_score and computer_score < 17:
        computer_cards.append(draw_card())
        computer_score = calculate_score(computer_cards)

    final_user_score = calculate_score(user_cards)
    final_computer_score = calculate_score(computer_cards)
    print(f"    Your final hand: {user_cards}, your total score: {final_user_score}")
    print(
        f"    Computer's final hand: {computer_cards}, computer's total score: {final_computer_score}"
    )

    if 21 < final_user_score:
        print("You lose.")
    elif 21 < final_computer_score:
        print("You Win.")
